    ...
    <div className="sticky h-0 z-20">
        ...
        <div className=" t:hidden mx-[1rem]">
            <div className="flex sm:justify-between sm:py-4 ">
                    ...
                    <div onClick={() => scrollToSection('intro')} className="text-[---tlogo] sm:text-[18px] t:text-[22px] cursor-pointer font-bold flex flex-row "><div><Image src={"/mypic.png"} alt="Img" width={25} height={25} className="rounded-[2rem] mx-2" /></div><p>AR</p></div>
        ...
        <div className="t:block t:mx-4 sm:hidden">
            <nav className="t:flex t:justify-between t:items-center t:py-4 ">
                    ...
                    <div onClick={() => scrollToSection('intro')} className="text-[---tlogo] t:text-[22px] l:text-[24px] ll:text-[28px] cursor-pointer font-bold flex items-center flex-row"><div><Image src={"/mypic.png"} alt="Img" width={30} height={30} className="rounded-[2rem] mx-2" /></div><p>AR</p></div>
