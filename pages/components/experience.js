...
const Experience = () => {
    ...
    <span className="text-[---bluecircleofcodeblock] bg-[---labelbg] text-[18px] font-bold p-2 rounded-[10px] px-[1rem]">Experience</span>
        <div className="sm:text-center sm:justify-items-center ">
            ...
            <div className=" sm:w-[90vw] items-center space-x-2 text-center p-2 cursor-pointer border-[0.1px] rounded-[2rem] mb-[1rem] py-4 hover:scale-[1.04] neon-border-for-experince duration-[1s]">
                ...
                <div>
                    ...
                    <div className="text-[---tw]  ">Code and build something in everyday</div>
                    </div>
                </div>
